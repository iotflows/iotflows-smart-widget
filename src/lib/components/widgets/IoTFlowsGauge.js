      ...
      plotOptions: {
          solidgauge: {
              dataLabels: {
                  enabled: true,
                  borderWidth: 0,
                  format: `<span style="font-size:2em; color: {point.color}; font-weight: bold">{point.y}${(this.props.widget_settings && this.props.widget_settings.options && this.props.widget_settings.options.unit && this.props.widget_settings.options.unit.value) ? this.props.widget_settings.options.unit.value : ''}</span>`,
              },
              linecap: 'round',
